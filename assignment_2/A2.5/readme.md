In order to run the two haskell programs prog1.hs and prog2.hs, you need to have haskell installed. Visit https://www.haskell.org/get-started/ to find the proper install method for your os.
